...
_SEA_DAYS: dict[str, int] = {
    ...
    "Port of Genoa":        18,
    "Port of Oslo":         29,
    "Port of Felixstowe":   23,
    "Port of Zurich (via Rotterdam)": 25,
    "Port of Valencia":     20,
    "Port of Miami":        11,
    "Port of Yokohama":     38,
    "Port of Shanghai":     35,
    "Port of Busan":        37,
    "Port of Buenos Aires":  4,
    "Port of Cartagena":    10,
    "Port of Veracruz":     14,
    "Port of Jeddah":       28,
    "Port of Jebel Ali":    26,
...
DESTINATION_PORTS: dict[str, dict] = {
    "Germany":        {"name": "Port of Hamburg",      "dhl_index": 62, "handling_days": 3},
    "European Union": {"name": "Port of Hamburg",      "dhl_index": 62, "handling_days": 3},
    "Netherlands":    {"name": "Port of Rotterdam",    "dhl_index": 45, "handling_days": 3},
    "Belgium":        {"name": "Port of Antwerp",       "dhl_index": 48, "handling_days": 3},
    "France":         {"name": "Port of Le Havre",     "dhl_index": 52, "handling_days": 3},
    "Italy":          {"name": "Port of Genoa",        "dhl_index": 58, "handling_days": 3},
    "Norway":         {"name": "Port of Oslo",         "dhl_index": 38, "handling_days": 3},
    "Switzerland":    {"name": "Port of Zurich (via Rotterdam)", "dhl_index": 41, "handling_days": 6},
    "United Kingdom": {"name": "Port of Felixstowe",   "dhl_index": 55, "handling_days": 3},
    "Spain":          {"name": "Port of Valencia",     "dhl_index": 50, "handling_days": 3},
    "United States":  {"name": "Port of Miami",        "dhl_index": 58, "handling_days": 3},
    "Japan":          {"name": "Port of Yokohama",     "dhl_index": 44, "handling_days": 4},
    "China":          {"name": "Port of Shanghai",     "dhl_index": 71, "handling_days": 4},
    "South Korea":    {"name": "Port of Busan",        "dhl_index": 40, "handling_days": 4},
    "Argentina":      {"name": "Port of Buenos Aires",  "dhl_index": 48, "handling_days": 2},
    "Colombia":       {"name": "Port of Cartagena",     "dhl_index": 52, "handling_days": 3},
    "Mexico":         {"name": "Port of Veracruz",     "dhl_index": 50, "handling_days": 3},
    "Saudi Arabia":   {"name": "Port of Jeddah",       "dhl_index": 48, "handling_days": 4},
    "UAE":            {"name": "Port of Jebel Ali",    "dhl_index": 42, "handling_days": 3},
    ...
    async def analyze(self, origin: str, destination: str, commodity: str, trade_direction: str = "export") -> dict:
        ...
        if is_import:
            ...
            if dest_port["dhl_index"] > 60:
                recommendations.append(
                    f"Consider alternative routing via Port of Rotterdam (DHL Index 45) to reduce port congestion risk."
                )
